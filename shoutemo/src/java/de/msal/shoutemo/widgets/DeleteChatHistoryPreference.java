    ...
    public void onClick(DialogInterface dialog, int which) {
        switch (which) {
            case DialogInterface.BUTTON_POSITIVE:
                int delCount = getContext().getContentResolver().delete(ChatDb.Messages.CONTENT_URI, null, null);
                Toast.makeText(getContext(), getContext().getResources()
                        .getString(R.string.pref_clear_chat_history_deleted, delCount), Toast.LENGTH_SHORT).show();
                break;
