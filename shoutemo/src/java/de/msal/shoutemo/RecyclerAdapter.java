...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        String message = mCursor.getString(mCursor.getColumnIndex(ChatDb.Messages.COLUMN_NAME_MESSAGE_HTML));
        String author = mCursor.getString(mCursor.getColumnIndex(ChatDb.Messages.COLUMN_NAME_AUTHOR_NAME));
        long timestamp = mCursor.getLong(mCursor.getColumnIndex(ChatDb.Messages.COLUMN_NAME_TIMESTAMP));
        ...
        if (getItemType(mCursor.getPosition()).equals(Message.Type.SHOUT)) {
            ...
            switch (Author.Type.valueOf(mCursor.getString(mCursor.getColumnIndex(ChatDb.Authors.COLUMN_NAME_TYPE)))) {
                case ADMIN:
                    viewHolder.mTvAuthor.setTextColor(mContext.getResources().getColor(R.color.autemo_blue));
                    break;
                case MOD:
                    viewHolder.mTvAuthor.setTextColor(mContext.getResources().getColor(R.color.autemo_green_secondary));
                    break;
                default:
                    viewHolder.mTvAuthor.setTextColor(mContext.getResources().getColor(R.color.autemo_grey_bright));
                    break;
            }
        }
        /* EVENTS */
            ...
            switch (getItemType(mCursor.getPosition())) {
                ...
                /* styling */
                    ...
                    viewHolder.mTvMessage.setTextColor(mContext.getResources().getColor(R.color.autemo_grey));
                    viewHolder.mTvTimestamp.setTextColor(mContext.getResources().getColor(R.color.autemo_grey_bright));
                ...
                /* styling */
                    ...
                    viewHolder.mTvMessage.setTextAppearance(mContext, android.R.style.TextAppearance_Medium);
                    ...
                    viewHolder.mTvTimestamp.setTextColor(mContext.getResources().getColor(R.color.autemo_trns_white));
                ...
                /* styling */
                    ...
                    viewHolder.mTvTimestamp.setTextColor(mContext.getResources().getColor(R.color.autemo_grey));
                ...
                /* styling */
                    ...
                    viewHolder.mTvMessage.setTextColor(mContext.getResources().getColor(R.color.autemo_white_dirty));
                    viewHolder.mTvTimestamp.setTextColor(mContext.getResources().getColor(R.color.autemo_white_dirty));
