...
public class ListAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        if (getItemType(cursor.getPosition()).equals(Message.Type.SHOUT)) {
            ...
            view.setTag(R.id.listrow_shout_timestamp, view.findViewById(R.id.listrow_shout_timestamp));
        } else {
            view = inflater.inflate(R.layout.listrow_event, parent, false);

            view.setTag(R.id.listrow_event_global_title, view.findViewById(R.id.listrow_event_global_title));
            ...
            view.setTag(R.id.listrow_event_timestamp, view.findViewById(R.id.listrow_event_timestamp));
        }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        if (getItemType(cursor.getPosition()).equals(Message.Type.SHOUT)) {
            ...
            switch (Author.Type.valueOf(
                ...
                case ADMIN:
                    tvAuthor.setTextColor(context.getResources().getColor(R.color.autemo_blue));
                    break;
                case MOD:
                    tvAuthor.setTextColor(context.getResources().getColor(R.color.autemo_green_secondary));
                    break;
                default:
                    tvAuthor.setTextColor(context.getResources().getColor(R.color.autemo_grey_bright));
                    break;
            }
        }
        /* EVENTS */
            ...
            switch (getItemType(cursor.getPosition())) {
                ...
                case AWARD:
                /* styling */
                    parent.setBackgroundColor(context.getResources().getColor(R.color.autemo_white_dirty));
                    tvMessage.setTextColor(context.getResources().getColor(R.color.autemo_grey));
                    tvTimestamp.setTextColor(context.getResources().getColor(R.color.autemo_grey_bright));
                    ivIcon.setImageResource(R.drawable.ic_event_award);
                /* alter message */
                    message = context.getResources().getString(R.string.award_author, author) + message;
                    break;
                case GLOBAL:
                /* styling */
                    parent.setBackgroundColor(context.getResources().getColor(R.color.autemo_pink));
                    ...
                    tvMessage.setTextColor(context.getResources().getColor(R.color.autemo_grey));
                    tvMessage.setLinkTextColor(context.getResources().getColor(R.color.autemo_yellow_dark));
                    tvTimestamp.setTextColor(context.getResources().getColor(R.color.autemo_trns_white));
                ...
                case COMPETITION:
                /* styling */
                    parent.setBackgroundColor(context.getResources().getColor(R.color.autemo_blue));
                    tvMessage.setTextColor(context.getResources().getColor(R.color.autemo_grey));
                    tvMessage.setLinkTextColor(context.getResources().getColor(R.color.autemo_white_dirty));
                    tvTimestamp.setTextColor(context.getResources().getColor(R.color.autemo_grey));
                ...
                case PROMOTION:
                /* styling */
                    parent.setBackgroundColor(context.getResources().getColor(R.color.autemo_orange));
                    tvMessage.setTextColor(context.getResources().getColor(R.color.autemo_white_dirty));
                    tvTimestamp.setTextColor(context.getResources().getColor(R.color.autemo_white_dirty));
                    ivIcon.setImageResource(R.drawable.ic_event_promotion);
                /* alter message */
                    message = this.context.getResources().getString(R.string.promotion, author) + message;
                    break;
            }
        }
